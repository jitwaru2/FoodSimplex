...
public class Server {
	public static void main(String[] args){
		...
		try {
			System.out.println("Waiting for node.js connection on port " + port +  "...");
			server = new ServerSocket(port);
			client = server.accept();
			System.out.println("Node.js connected on port " + port);
			...
			while(true){
			    ...
			    while (status!=Protocol.endMsg) { //blocking here until it gets a newline
			    	...
			    	// read line; if line from Node.js is null, then it means Node.js closed the connection
			    	System.out.println("Waiting for line " + counter + ":");
			    	if((inputLine = in.readLine())==null){
			    		System.out.println("Connection died; exiting...");
			    		System.exit(1);
			    	}
			    	System.out.print("Received line " + counter + ": " + inputLine);
			    	msg+= inputLine+'\n';
			    ...
			    System.out.println("Total lines read: " + counter);
			    System.out.println("Complete msg received from Node.js:");
